...
import telegramIcon from "@/assets/telegram-icon.png"; // замените на актуальное имя файла
import maxIcon from "@/assets/max-icon.png"; // замените на актуальное имя файла
  ...
  return (
    <div className="fixed bottom-4 left-4 right-4 z-50 md:hidden">
      ...
      <div className="flex justify-end gap-3 mb-2">
        ...
        {/* MAX */}
        <a
          href="https://max.ru/u/f9LHodD0cOJQ6eI2WZyF-SaYJA3j7qG5d0BjL26gFfr1I6Lt2OSpGmTJ_AI"
          target="_blank"
          rel="noopener noreferrer"
          className="transition-transform duration-200 hover:scale-110 active:scale-95"
        >
      ...
      >
        ...
        <span className="text-lg font-semibold">8 (994) 305 05 05</span>
      </a>
    </div>
  );
};
